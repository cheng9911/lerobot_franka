...
PORT_CONFIG_MAP: Dict[str, DynamixelRobotConfig] = {
    ...
    "/dev/serial/by-id/usb-1a86_USB_Serial-if00-port0": DynamixelRobotConfig(
        ...
        # 6.347, 3.082, 4.752, 6.531, 3.075, 6.289, 3.991
        # 1.622, 6.010, 0.153, 3.863, 4.589, 5.030, 4.100
        1.723, 6.047, 6.347, 3.658, 4.595, 4.750, 0.903
        ...
        joint_signs=(1, -1, 1, 1, 1, -1, 1),
        gripper_config=(7, 115.903515625, 73.488),
    ),
